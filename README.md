...
> **Status: `0.3.0` is on Maven Central, and the API is not stable.** A `0.x` line: expect
...
```kotlin
dependencies {
    implementation("dev.ynagai.a2ui:a2ui-material3:0.3.0")
}
```
...
```kotlin
implementation("dev.ynagai.a2ui:a2ui-compose:0.3.0")
implementation("dev.ynagai.a2ui:a2ui-core:0.3.0")
```
...
```kotlin
implementation("dev.ynagai.a2ui:a2ui-material3-markdown:0.3.0")
```
...
### What `0.3.0` requires of your build
