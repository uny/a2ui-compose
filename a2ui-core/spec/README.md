...
commit below. **The revisions differ per row on purpose** -- a document is bumped when upstream
changes it, so a row still naming an older commit means that file has not moved since, not that it
was missed.
...
|:--|:--|:--|
| `v1_0/common_types.json` | [`a2ui-project/a2ui`](https://github.com/a2ui-project/a2ui) `specification/v1_0/json/common_types.json` | `676a8999` |
