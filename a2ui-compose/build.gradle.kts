 ...
 * into a failure at the end of a release run instead of the start of one. `publishToMavenLocal`
 * is exempted by the plugin, so the consumer smoke test needs no key.
 *
